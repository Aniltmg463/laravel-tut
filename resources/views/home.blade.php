...
<div class="container mt-5">
        <div class="row">
            <div class="col-12">
                {{-- <a href="{{ route('post.create') }}" class="btn btn-info btn-sm mb-3">Add New</a> --}}
                 <a href="{{ route('post.create')}}" class="btn btn-info btn-sm mb-3">Add New</a>
                    ...
                    <tbody>
                        @foreach ($post as $p)
                            <tr>
                                ...
                                <td>{{ $p->city }}</td>
                                <td>
                                    {{-- <a href="{{ route('post.show', $p->id) }}" class="btn btn-info btn-sm">View</a> --}}
                                    <a href="{{ route('post.show',$p->id ) }}" class="btn btn-info btn-sm">View</a>
                                </td>
                                
                                <td>
                                    {{-- <a href="{{ route('post.edit', $p->id) }}" class="btn btn-warning btn-sm">Update</a> --}}
                                     <a href="{{ route('post.edit', $p->id) }}" class="btn btn-warning btn-sm">Update</a>
                                </td>
